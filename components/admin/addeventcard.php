...
<div class="add-event-card">
    <form action="/views/admin/manage-events/add_event.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" onfocus="(this.type='datetime-local')" onblur="(this.type='text')" placeholder="Event Start Date"name="event-start-date" id="event-start-date" required>
        <input type="text" onfocus="(this.type='datetime-local')" onblur="(this.type='text')" placeholder="Event End Date" name="event-end-date" id="event-end-date" required>
