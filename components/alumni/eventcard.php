...
<?php 
include($_SERVER['DOCUMENT_ROOT'].'/controllers/alumni/events.controller.php');
?>
<div class="container">
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-12 event-card">
                <div class="card mb-3"  style="width:90%;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="<?=$row['image']?>" style="width:200px;"alt="...">
                        </div>
                        <div class="col-md-6">
                            <div class="card-body">
                                <a href="/views/alumni/events/event.php?id=<?=$row['id']?>">
